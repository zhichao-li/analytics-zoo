...
object DenseLoader extends LayerLoader {
  ...
  override def getWeightsFromH5(h5File: HDF5Reader, layerName: String): Array[Tensor[Float]] = {
    val kerasWeights = Array(
      h5File.readDataSet(s"model_weights/${layerName}/${layerName}/kernel:0"),
      h5File.readDataSet(s"model_weights/${layerName}/${layerName}/bias:0"))
    toZooFormat(kerasWeights)
  }
